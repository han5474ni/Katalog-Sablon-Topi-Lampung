<x-admin-layout title="Detail Pesanan Ditolak">
    @push('styles')
        {{-- Pastikan path ini sesuai dengan struktur proyek Anda --}}
        @vite(['resources/css/admin/order-detail-custom-rejected.css'])
...
<div class="order-detail-container">
    ...
    <header class="page-header">
        <h1 class="page-title">
            ...
            Detail
            <span class="breadcrumb-separator">></span>
            <span class="breadcrumb-rejected">Ditolak</span>
        </h1>
    ...
    <div class="card custom-detail-card">
        ...
        <div class="stamp-container">
            <div class="stamp-ditolak">DITOLAK</div>
        </div>
